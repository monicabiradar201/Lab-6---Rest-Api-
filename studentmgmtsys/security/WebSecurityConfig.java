package com.greatlearning.studentmgmtsys.security;
	...
	import com.greatlearning.studentmgmtsys.service.UserDetailsServiceImpl;
	...
	public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
		...
		protected void configure(HttpSecurity http) throws Exception {
			http.authorizeRequests().antMatchers("/", "/student/list",  "/student/403")
					.hasAnyAuthority("USER", "ADMIN").antMatchers("/student/showFormForUpdate","/student/showFormForAdd", "/student/delete")
